...
assert.match(swift, /let cardWidth: CGFloat = dynamicTypeSize\.isAccessibilitySize \? \.infinity : 276/);
assert.match(swift, /struct QuoteHero[\s\S]*\.frame\(maxWidth: cardWidth, minHeight: minimumHeight\)\s*\.background \{/);
