...
assert.match(swift, /struct TodayView[\s\S]{0,240}@State private var showingSettings = false/);
assert.match(swift, /struct TodayView[\s\S]*?\.sheet\(isPresented: \$showingSettings\) \{\s*SettingsView\(\)/);
