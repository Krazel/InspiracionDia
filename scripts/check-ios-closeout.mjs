...
assert.match(swift, /struct RootView[\s\S]*?ZStack \{[\s\S]*?\n    \}\n    \.sheet\(isPresented: \$showingSettings\)/);
...
assert.match(project, /CODE_SIGN_ENTITLEMENTS: InspiracionDia\.entitlements/);
...
assert.match(testFlightWorkflow, /PROFILE_ASSOCIATED_DOMAIN/);
assert.match(testFlightWorkflow, /com\.apple\.developer\.associated-domains:0/);
assert.match(testFlightWorkflow, /applinks:krazel\.github\.io/);
