...
- first-run and app preference settings.
...
When the user selects Share, Warm Words creates a quote-card image and presents the standard iOS share sheet. The user chooses whether and where to send it. Warm Words does not receive the selected destination, recipient details, or the shared content after it leaves the app. The selected destination handles the item under its own terms and privacy policy.
